  ...
  <div class="page-container">
    <a-card>
      ...
      <div class="search-bar">
        ...
        <a-button style="margin-left: auto" type="primary" @click="openCreate">新建角色</a-button>
      </div>
      ...
      >
        ...
        <template #action="{ record }">
          <a-space>
            <a-button type="text" size="small" @click="openEdit(record as unknown as SysRoleDetail)">编辑</a-button>
            <a-popconfirm
              :content="record.status === 'active' ? '确认禁用该角色？' : '确认启用该角色？'"
